...
#    # Select Urban Adult Contemporany
     Wait Until Element Is Visible   id=com.sentrics.engage360:id/name
    Element Should Be Visible       id=com.sentrics.engage360:id/name      Urban Adult Contemporany
    Press Keycode       20
    Press Keycode       20
    # Back
    Press Keycode       4
    ...
    Press Keycode       20
    Wait Until Element Is Visible   id=com.sentrics.engage360:id/name
    Element Should Be Visible       id=com.sentrics.engage360:id/name     Conteporary Christian Blend


    # Select Tab Conteporary Gospel
    Press Keycode       20
    Wait Until Element Is Visible   id=com.sentrics.engage360:id/name
    Element Should Be Visible       id=com.sentrics.engage360:id/name     Conteporary Gospel
